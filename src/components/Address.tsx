...
const Address: React.FC<AddressProps> = ({ 
  ...
  iconSize = 24,
  addressDetails = {
    street: 'R9WG+XHF, Unnamed Road, Mechiabasti, Jaigaon, West Bengal 736182',
    phone: '99326 70114',
  ...
  return (
    <ul className={`${className}`}>
      ...
      <li className="flex items-center gap-4">
        ...
        <a href={`tel:${addressDetails.phone.replace(/\D/g, '')}`} className='hover:text-primary'>
      ...
      <li className="flex items-center gap-4">
        ...
        <a href={`mailto:${addressDetails.email}`} className='hover:text-primary'>
